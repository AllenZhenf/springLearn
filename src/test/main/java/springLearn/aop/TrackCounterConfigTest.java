package test.main.java.springLearn.aop;

import main.java.springLearn.aop.TrackCounter;
import main.java.springLearn.aop.TrackCounterConfig;
...
public class TrackCounterConfigTest {
    ...
    public void trackCounter() throws Exception {
        ...
        Assert.assertEquals(6,trackCounter.getPlayCount(3));
